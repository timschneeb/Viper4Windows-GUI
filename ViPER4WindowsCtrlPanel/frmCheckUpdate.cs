...
namespace ViPER4WindowsBin
{
	...
	public partial class frmCheckUpdate : Syncfusion.WinForms.Controls.SfForm
    {
		...
		public frmCheckUpdate()
		{
			...
			this.singleButton_Check.Text = GlobalMessages.CHECK;
			this.singleButton_Copy.Text = GlobalMessages.COPY_DOWNLOAD_LINK;
        ...
        private void SingleButton_Check_Click(object sender, EventArgs e)
        {
        ...
        private void SingleButton_Copy_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
